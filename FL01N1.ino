...
//  Serial.println ("Pin setup complete. Hit a key to start radio");     // wait before doing startup to ascertain if the motor hum is present
//  while(Serial.available() == 0){}
...
//  Serial.println ("Setup complete. Hit a key to start main loop");     // wait before doing startup to ascertain if the motor hum is present
//  while(Serial.available() == 0){}
}
